...
const SECTIONS = [
  {
    title: 'مقدمة',
    content: `تلتزم منصة الصفاة (alsfat.com)، المملوكة لمؤسسة ماد يونيت للتجارة، بحماية خصوصية مستخدميها. توضّح هذه السياسة كيفية جمع بياناتك الشخصية واستخدامها وحفظها والحفاظ عليها وفق أحكام نظام حماية البيانات الشخصية في المملكة العربية السعودية.`,
  },
  {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.footer}>© 2024 مؤسسة ماد يونيت للتجارة · الصفاة · جميع الحقوق محفوظة</Text>
