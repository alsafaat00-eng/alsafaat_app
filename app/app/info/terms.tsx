...
const TERMS = [
  ...
  },
  {
    ...
    content: `تُقدَّم المنصة "كما هي" دون ضمانات صريحة أو ضمنية. لا تتحمل الصفاة أو مؤسسة ماد يونيت للتجارة مسؤولية أي خسائر تنتج عن استخدام المنصة أو المعاملات المُبرمة عبرها.`,
  },
  {
